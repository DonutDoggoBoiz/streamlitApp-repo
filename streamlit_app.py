      ...
      with placeholder_3.container():
        ...
        if view_model_detail:
          ...
          with st.expander('Model information:',expanded=True):
              ...
              st.write('Epsilon decline : {}'.format(model_frame_u.loc[model_frame_u['model_name']==selected_row_model_name,'epsilon_decline'].to_list()[0]))
              ...
              st.write('Learning Rate : {}'.format(model_frame_u.loc[model_frame_u['model_name']==selected_row_model_name,'learning_rate'].to_list()[0]))
              ...
              with edit_form_col1:
                with st.form('edit parameter form'):
                  ...
                  edt_agent_epsilon_dec = st.select_slider("Epsilon decline rate (random walk probability decline): ",
                                                           ...
                                                           options=[0.000025,0.00005,0.0001,0.0002,0.0005,0.001],
            ...
            with st.form('set_param_new_model'):
              ...
              with col1_set_para:
                ...
                nm_agent_epsilon_dec = st.select_slider("Epsilon decline rate (random walk probability decline):",
                                                     options=[0.000025,0.00005,0.0001,0.0002,0.0005,0.001], value=0.0001, help=param_help_dict['eps_dec'])
